package dev.jhonis.ecommerce.checkout.steps;

import dev.jhonis.ecommerce.checkout.SpringIntegrationTest;
...
public class StepDefinition extends SpringIntegrationTest {
    ...
    public void checkoutCode(String checkoutCode) {
        ...
        Mockito.when(uuidUtil.createUUID()).thenReturn(checkoutCode);
    }
}
